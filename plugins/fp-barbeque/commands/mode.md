---
description: fp-barbeque control — show status or switch mode (status/on/off/help)
argument-hint: [status|on|off|help]
allowed-tools: Bash(node:*)
---

The line below is the deterministic result of the fp-barbeque control CLI (the
